<template>
	<view>
        ...
        <view class="header">
			<view  class="uni-btn-icon" style="color: rgb(0, 0, 0); font-size: 27px;"></view>
		...
		<view class="category-list">
			...
			<!-- 右侧子导航 -->
			<scroll-view  scroll-y="true" class="right"  style="background: #ffffff;">
	...
	export default {
		data() {
			return {
				...
				//分类列表
				categoryList:[
					{id:1,title:'手办',banner:'/static/img/category/banner.jpg',list:[
						{name:'冰箱',	img:'1.jpg'},
						{name:'电视',	img:'2.jpg'},
						{name:'空调',	img:'3.jpg'},
						{name:'洗衣机',	img:'4.jpg'},
					...
					{id:2,title:'服饰',banner:'/static/img/category/banner.jpg',list:[
						{name:'打印机',	img:'1.jpg'},
						{name:'路由器',	img:'2.jpg'},
						{name:'扫描仪',	img:'3.jpg'},
						{name:'投影仪',	img:'4.jpg'},
					...
					{id:3,title:'模型',banner:'/static/img/category/banner.jpg',list:[
						{name:'茶具',	img:'1.jpg'},
						{name:'花瓶',	img:'2.jpg'},
						{name:'纸巾',	img:'3.jpg'},
						{name:'毛巾',	img:'4.jpg'},
					...
					{id:4,title:'周边',banner:'/static/img/category/banner.jpg',list:[
						{name:'苹果',	img:'1.jpg'},
						{name:'芒果',	img:'2.jpg'},
						{name:'椰子',	img:'3.jpg'},
						{name:'橙子',	img:'4.jpg'},
...
.category-list .right .category[data-v-748e2a18]{
			width: 100%;
		}
</style>
